...
from ...core.utils.common import is_frozen
from ..security.secure_config import SecureConfigManager
from ..settings import CONFIG_DIR, DATA_DIR, DEFAULT_CONFIG_FILE
...
class CodexConfig:
    ...
    def _get_default_config_path(self: "Self") -> Path | None:
        ...
        if is_frozen():
            ...
            # Development: use the one in the package
            # This assumes this file is at src/aichemist_archivum/config/loader/config_loader.py
            # And default config is at src/aichemist_archivum/config/default_config.yaml
            package_root = Path(__file__).resolve().parent.parent
            default_path = package_root / DEFAULT_CONFIG_FILE
    ...
    @overload
    def get(self: "Self", key: str, default: None = None) -> Any | None: ...

    def get(self: "Self", key: str, default: T | None = None) -> T | Any | None:
    ...
    def get_secure(self: "Self", key: str, default: Any | None = None) -> Any | None:
    ...
    def set_secure(self: "Self", key: str, value: Any) -> None:
